...
Form::NotSignedException::NotSignedException(NotSignedException const &notSignedException) throw() {
	*this = notSignedException;
	return;
}

Form::NotSignedException &Form::NotSignedException::operator=(NotSignedException const &notSignedException) throw() {
